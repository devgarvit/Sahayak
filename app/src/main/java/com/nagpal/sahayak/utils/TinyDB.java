...
package com.nagpal.sahayak.utils;
...
public class TinyDB {
    ...
    public List getListObject(String key, Class<?> mClass) {
        Gson gson = new Gson();
    ...
    /*
    Always check for null while using this method
     */
    ...
    public void putListObject(String key, List objArray) {
        ...
        if (objArray != null && objArray.size() > 0) {
            for (int i = 0; i < objArray.size(); i++) {
                objStrings.add(gson.toJson(objArray.get(i)));
            }
    ...
    public void putListObjectJackson(String key, List objArray) {
        checkForNullKey(key);
//        ObjectMapper objectMapper = new ObjectMapper();
        ...
        if (objArray != null && objArray.size() > 0) {
            for (int i = 0; i < objArray.size(); i++) {
                try {
//                    objStrings.add(objectMapper.writeValueAsString(objArray.get(i)));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
